...
(defmacro define-language ((parse-fn define-singleton define-clause)
  ...
  #.(format nil "Define a language processor function PARSE-FUNCTION, with macros to define its behaviors ~
DEFINE-SINGLETON and DEFINE-CLAUSE.
...
If DEFINE-SINGLETON is `nil', no defining macro will be generated.
